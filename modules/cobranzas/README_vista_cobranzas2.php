            ...
            <form method="GET" class="filters-row">
                ...
                <div class="filter-group" style="flex:2; min-width:300px;">
                    ...
                    <div style="display: flex; gap: 10px;">
                        <input type="text" name="f_txt" value="<?php echo htmlspecialchars($f_txt); ?>" placeholder="Ej: Farmacia Tariba o 177465..." style="flex: 1;">
                        <button type="submit" class="btn-search"><i class="fas fa-magnifying-glass"></i> BUSCAR</button>
                    </div>
                </div>
            </form>
        </section>
