...
<style>
/* Estilos específicos que NO están en style.css (principalmente el Modal) */
.modal-overlay {
    display: none;
    position: fixed;
    inset: 0;
...
/* Sobreescrituras para coherencia con style.css */
.erp-page { min-height: 100vh; padding-bottom: 40px; }
...
#table-audit td:nth-child(4) { min-width: 320px; white-space: normal; } /* Cliente / Pagador */
#table-audit td.product-name { white-space: normal !important; max-width: none !important; }
#table-audit th:last-child { min-width: 150px; } /* Estatus */
.table-container { border-radius: 0 0 var(--radius-lg) var(--radius-lg); overflow-x: auto; }
#table-audit thead th { position: sticky; top: 0; z-index: 10; background: var(--bg-card); box-shadow: inset 0 -2px 0 var(--border); }
